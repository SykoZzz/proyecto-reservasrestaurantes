...
using appReservas.Models; // 👈 Asegúrate de tener esto
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.NombreCompleto = Input.NombreCompleto; // 👈 Guardamos el nombre completo
        ...
        private ApplicationUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"No se pudo crear una instancia de '{nameof(ApplicationUser)}'. " +
                    $"Asegúrate de que tenga un constructor sin parámetros.");
            }
        }
